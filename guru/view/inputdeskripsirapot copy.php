            ...
            <input type="hidden" name="c_mapel" value="<?php echo $_GET['r'] ?>">
              <table class="table table-bordered table-hover">
                ...
                <?php $lsis=mysqli_query($con,"SELECT * FROM siswa where c_kelas='$_GET[q]' order by nama asc "); $no=1; while($hlsis=mysqli_fetch_array($lsis)){
                  ...
                  $amnil=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM deskripsi_rapot where c_ta='$c_ta' and c_siswa='$hlsis[c_siswa]' and c_kelas='$_GET[q]' and c_mapel='$_GET[r]' ")); ?>
                  <tr>
                    <td><?php echo $no; ?></td>
              ...
              <div class="box-footer"><a data-target="#inputdes" data-toggle="modal" class="btn btn-success" href="">Simpan Nilai</a> &nbsp;&nbsp;
                <?php $ceknil=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM deskripsi_rapot where c_kelas='$_GET[q]' and c_mapel='$_GET[r]' and c_ta='$c_ta' ")); if($ceknil==NULL){ ?>
