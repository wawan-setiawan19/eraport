...
<div class="row">
        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            ...
            <input type="hidden" name="fotolama" value="<?php echo $hasis['foto_siswa']; ?>">
            <input type="hidden" name="c_siswa" value="<?php echo $_GET['q']; ?>">
              <div class="box-body">
                ...
                <p><img src="<?php echo $base.$hasis['foto_siswa']; ?>" style="width:100px; height:90px;"></p>
                <div class="form-group">
                  <label>Foto Siswa</label>
                  <input type="file" name="fotosiswa" class="form-control">
                </div>
              </div>
              <!-- /.box-body -->
