        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
            	<h4> <i class="glyphicon glyphicon-pencil"></i> SETTING WALI GRADE<span class="pull-right"><div style="color:#428bca;">KELAS: <?php echo $kel['kelas']; ?></div><div style="color:#5cb85c;">MAPEL DINIYAH: <?php echo $md['nama_mapelmd']; ?></div><div style="">KKM: <?php echo $md['kkm_mapelmd']; ?></div></span></h4>
            </div>
            <form action="<?php echo $basewa; ?>a-walikelas/<?php echo md5('inputwaligrade'); ?>/access" method="post">
...
<?php $smk=mysqli_query($con,"SELECT * FROM siswa  where c_kelas='$kel[c_kelas]' order by nama asc "); $vr=1;while($akh=mysqli_fetch_array($smk)){ ?>                
                <tr>
                  ...
                  <td><input name="wali_grade[]" class="form-control" value="<?= $akh['wali_grade']?>"></input></td>
                </tr>
<?php $vr++; } ?>
                </tbody>
              </table>
            ...
            <div class="box-footer">
              <button class="btn btn-primary">Simpan Setting Wali Grade</button>
